...
Partial Class Test
    ...
    Private Sub InitializeComponent()
        ...
        Me.ComboBox1.Items.AddRange(New Object() {"Logistic regression", "ALLE DATA LINEAR", "Linear regression", "Decision tree", "Lagrange Interpolating Polynomial", "Data mining algorithms: Prediction", "Bayes' theorem", "Bayes' theorem & Linear", "Bayes' theorem with year", "Bayes & Bayes-Linear"})
